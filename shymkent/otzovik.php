...
?>
  ...
  <script src='https://www.google.com/recaptcha/api.js'></script>
    <meta charset="utf-8">
    <title>Отзывы о компании Icegroup - холодильные оборудования: холодильные шкафы, витрины, бонеты, морозильные лари, кондитерские витрины, настольные витрины, холодильные столы в Шымкент. </title>
