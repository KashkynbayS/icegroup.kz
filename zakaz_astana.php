...
<div class="container">
	...
	<div class="row">
		...
		<p style="font-size:16px"><b>Если Вы хотите оставить заявку, заполните эту форму.</b></p>
		<p style="font-size:16px">Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.</p>
		<p style="font-size:16px">Или пишите на почту: <b>astana@idiamarket.kz</b></p>
<form action="https://formspree.io/astana@idiamarket.kz"
      method="POST">		
	  <br>
