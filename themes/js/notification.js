...
$("#fly").click(function() {
    ...
    let product_notif = btn_fly.getAttribute('data-id')
    console.log("btn_fly");


    toastr["info"]("<img class='galochka' src='/themes/images/galochka.png' alt='galochka'>" + product_notif + "Товар добавлен в корзину");
});