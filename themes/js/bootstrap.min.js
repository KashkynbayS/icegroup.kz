...
if (window.matchMedia('(max-width: 500px)').matches) {
    ...
    if (service__block1__img1 != null) {
        ...
        document.querySelector(".service__block1__img1").style.background = "linear-gradient(rgba(0, 0, 0, 0.71), rgba(0, 0, 0, 0.71)), url('/themes/images/service/webp_mobile/main.webp') no-repeat fixed center / cover";
