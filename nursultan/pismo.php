...
<html lang="en">
  <head>
    <meta charset="utf-8">
     <title>Контакты IceGroup в Астана: ул. Бейсекбаева 24/1, 2-этаж, мебельный центр DARA.</title>
<meta name="keywords" content="контакты Icegroup, Idia market Астана">
<meta name="description" content="Контакты, адрес, телефон компании Icegroup Астана. Звоните!">
<!--Less styles -->
...
<div class="container">
	...
	<div class="row">
		...
		<p style="font-size:16px">Если Вы хотите отправить письмо <b>руководству</b> с предложениями, замечаниями или по вопросам сотрудничества заполните эту форму.</p>
		<p style="font-size:16px">Ваши сообщения напрямую проходят руководству. Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.</p>
		<p style="font-size:16px">Или пишите на почту: <b>admin@idiamarket.kz</b></p>
<form action="https://formspree.io/admin@idiamarket.kz"
      method="POST">		
	  <br>
	  <p style="font-size:14px; margin-bottom:0">Ваше имя (наименование организации)<span class="asterisk">*</span></p>
   <input type="text" name="name" class="textbox" required="">
   <p style="font-size:14px; margin-top:10px; margin-bottom:0">Ваш e-mail<span class="asterisk">*</span></p>
  <input type="text" name="email" class="textbox">
	  <p style="font-size:14px; margin-top:10px; margin-bottom:0">Номер телефона<span class="asterisk">*</span></p>
    <input id="phone" type="text" name="phone" class="textbox" required="">
	<p style="font-size:14px; margin-top:10px; margin-bottom:0; float:none">Ваше сообщение<span class="asterisk">*</span></p>
  <textarea type="text" name="message" class="textbox1" style="float:none;"></textarea>
	<input type="hidden" name="_next" value="pismo.php">
	
<div style="margin-top:10px; float:none"><input type="submit" class="vpb_general_button" value="Отправить"></div>
</form>	
		</div>
	...
	<div class="span12" style="margin-bottom:20px; margin-top:20px">
	<img src="/themes/images/ast.png"></div>
	<div class="span12">
<a class="dg-widget-link" href="http://2gis.kz/astana/firm/70000001027762786/center/71.45490646362306,51.17546878815025/zoom/14?utm_medium=widget-source&utm_campaign=firmsonmap&utm_source=bigMap">Посмотреть на карте Астаны</a><div class="dg-widget-link"><a href="http://2gis.kz/astana/firm/70000001027762786/photos/70000001027762786/center/71.45490646362306,51.17546878815025/zoom/17?utm_medium=widget-source&utm_campaign=firmsonmap&utm_source=photos">Фотографии компании</a></div><div class="dg-widget-link"><a href="http://2gis.kz/astana/center/71.460709,51.171686/zoom/14/routeTab/rsType/bus/to/71.460709,51.171686╎IDIA Market, производственно-торговая компания?utm_medium=widget-source&utm_campaign=firmsonmap&utm_source=route">Найти проезд до IDIA Market, производственно-торговая компания</a></div><script charset="utf-8" src="https://widgets.2gis.com/js/DGWidgetLoader.js"></script><script charset="utf-8">new DGWidgetLoader({"width":1200,"height":400,"borderColor":"#a3a3a3","pos":{"lat":51.17546878815025,"lon":71.45490646362306,"zoom":14},"opt":{"city":"astana"},"org":[{"id":"70000001027762786"}]});</script><noscript style="color:#c00;font-size:16px;font-weight:bold;">Виджет карты использует JavaScript. Включите его в настройках вашего браузера.</noscript>
	</div>
	</div>
</div>
</div>
